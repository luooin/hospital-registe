<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="collectList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户ID" align="center" prop="" />
      <el-table-column label="用户" align="center" prop="nickName" />
      <el-table-column label="医生" align="center" prop="sysUser.nickName" />
      <el-table-column label="科室" align="center" prop="pSection.deptName" />
      <el-table-column label="门诊" align="center" prop="pOutpatien.roomName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="科室ID" prop="sectionId">
          <el-input v-model="form.sectionId" placeholder="请输入科室ID" />
        </el-form-item>
        <el-form-item label="门诊ID" prop="outpatien">
          <el-input v-model="form.outpatien" placeholder="请输入门诊ID" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        outpatien: [
          { required: true, message: "门诊ID不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/collect/export', {
        ...this.queryParams
